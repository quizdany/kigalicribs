      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-headline text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            <TranslatableText>Why Choose</TranslatableText> <span className="text-primary">Kigali Cribs</span>?
          </h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              <Card className="h-full transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 bg-card">
                ...
                <CardContent>
                  <p className="text-gray-600"><TranslatableText>{feature.description}</TranslatableText></p>
                </CardContent>
              </Card>
            </motion.div>
          ))}
